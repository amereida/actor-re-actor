...
int maxDist = 420;  // máxima distancia para medir en centímetros
int maxSteps = 3500; // <---- DEFINIR AL COMIENZO DEL MONTAJE, es el número máximo de pasos entre una posicion inicial y una final
