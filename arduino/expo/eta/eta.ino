...
int maxDist = 480;  // máxima distancia para medir en centímetros
int maxSteps = -2000; // <---- DEFINIR AL COMIENZO DEL MONTAJE, es el número máximo de pasos entre una posicion inicial y una final
